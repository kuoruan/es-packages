 ...
 */
declare abstract class view<L = any> extends baseclass {
  /**
   * {@inheritDoc baseclass.extend}
   */
  static extend<view, T extends view>(properties: Partial<typeof view> & T): T;
   ...
   */
  abstract render(load_results: L | null): Node | Promise<Node>;
}
