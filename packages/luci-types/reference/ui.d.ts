declare namespace LuCI {
  class ui extends LuCI.baseclass {
    /**
     ...
     */
    createHandlerFn<T, F extends (this: T, ...args: any[]) => any>(
      ctx: T,
      fn: F | string,
      ...extra_args: any[]
    ): ((...args: any[]) => any) | null;
     ...
     * to.
     */
    itemlist(node: Node, items: any[], separators?: any | any[]): Node;
     ...
     */
    pingDevice(proto?: "http" | "https", host?: string): Promise<Event>;
     ...
     */
    showModal(title: string | null, contents: any, ...classes: string[]): Node;
  ...
  namespace ui {
    ...
    namespace AbstractElement {
      interface InitOptions {
         ...
         * converted to a string and treated as validation error message.
         */
        validate?: (val: string) => boolean | string | Record<string, unknown>;
