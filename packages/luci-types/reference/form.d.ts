declare namespace LuCI {
  class form extends LuCI.baseclass {}
  ...
  namespace form {
     ...
     */
    abstract class AbstractElement extends LuCI.baseclass {
      /**
       * Add another form element as children to this element.
       *
       * @param element - The form element to add.
       */
      append<E extends AbstractElement>(element: Newable<E>): void;
    ...
    class AbstractSection extends AbstractElement {
       ...
       */
      readonly parentoption: Newable<AbstractValue>;
    ...
    > extends Value<boolean | string, S> {
      /**
